...
public class TicTacToe_Game {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TicTacToe_Game window = new TicTacToe_Game();
	...
	private void initialize() {
		...
		panel_5.add(btn2, BorderLayout.CENTER);
		...
		panel_7.add(btn3, BorderLayout.CENTER);
		...
		playerX.setFont(new Font("Tahoma", Font.BOLD, 20));
		panel_9.add(playerX, BorderLayout.CENTER);
		...
		panel_3.add(btn5, BorderLayout.CENTER);
		...
		panel_2.add(btn6, BorderLayout.CENTER);
		...
		PlayerO.setFont(new Font("Tahoma", Font.BOLD, 20));
		panel_15.add(PlayerO, BorderLayout.CENTER);
		...
		panel_14.add(oCount, BorderLayout.CENTER);
		...
		panel_4.add(btnExit, BorderLayout.CENTER);
	}
}
